'''
Aum Sri Sai Ram
Implementation of ResNet18 baseline 
...
from resnet import resnet18 as net, count_parameters  
...
def main():
    ...
    # prepare model
    basemodel = net(  pretrained= False)
    basemodel.fc = nn.Linear(512, args.num_classes)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if is_best:
            ...
            torch.save(  {
                         ...
                         }, os.path.join(args.model_dir, 'best_checkpoint_rafdb_resnet18_pre_trained_msceleb.pth.tar'))
