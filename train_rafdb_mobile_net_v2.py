...
from mobilenet_v2_model import FERNet as net, count_parameters  
...
parser.add_argument('--resume', default='checkpoints_rafdb/best_checkpoint_mobile_net_v2_pre_trained_imagenet.pth.tar', type=str, metavar='PATH',   help='path to latest checkpoint (default: none)')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if is_best:
            torch.save(  {
                         ...
                         }, os.path.join(args.model_dir, 'best_checkpoint_mobile_net_v2_pre_trained_imagenet.pth.tar'))
