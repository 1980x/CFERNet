...
from nano_model import FERNet as net, count_parameters
...
parser.add_argument('--resume', default='checkpoints_rafdb/best_checkpoint_nano.pth.tar', type=str, metavar='PATH',   help='path to latest checkpoint (default: none)')
...
parser.add_argument('--imagesize', type=int, default = 48, help='image size (default: 224)')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if is_best:
            torch.save(  {
                         ...
                         }, os.path.join(args.model_dir, 'best_checkpoint_nano.pth.tar'))
