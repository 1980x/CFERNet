...
from dataset.sfew_dataset_mirror import ImageList
...
parser.add_argument('--test_list', type=str, default ='../data/SFEW/sfew_val.txt',
#val_raf_db_list_pose_30.txt, val_raf_db_list_pose_45.txt,rafdb_occlusion_list.txt ,test_label.txt')
...
parser.add_argument('--resume', default='checkpoints_rafdb/best_of_all_checkpoint.pth.tar', type=str, metavar='PATH',   help='path to latest checkpoint (default: checkpoints_rafdb/best_of_all_checkpoint.pth.tar)')
...
def main():
    ...
    test_data = ImageList(root=args.root_path +'Val_Aligned_Faces/', fileList=args.test_list,
